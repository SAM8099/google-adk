...
async def add_current_problem(session_service, app_name, user_id, session_id, text):
...
async def add_tutor_question(session_service, app_name, user_id, session_id, text):
...
async def add_user_answer(session_service, app_name, user_id, session_id, text):
...
async def add_content(session_service, app_name, user_id, session_id, text):
